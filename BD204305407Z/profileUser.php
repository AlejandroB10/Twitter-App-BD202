            ...
            <div class="px-6">
                ...
                <div class="text-center mt-2">
                    ...
                    <div class="flex flex-row justify-center items-center">
                        <?php ?>
                        <a class="text-sm mt-0 mb-2 text-slate-400 font-bold text-center border rounded-full px-1 py-1 w-20 mt-5" id="user_follow">Seguir</a>
                        <?php   ?>
                    </div>
                </div>
