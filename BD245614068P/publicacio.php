...
$publicacions_query = "SELECT * FROM publicacio WHERE idHistoria = NULL ORDER BY dataPub DESC";
                            ...
                            <div class="col-span-2 flex items-center justify-start">
                                ...
                                <a href="#">
                                    <span class="block flex items-center justify-center font-semibold w-32 p-1 text-slate-400 border-2 border-slate-400 rounded-full text-sm transition duration-300 group-hover:text-blue-600">
                                        Compartir
                                        <lord-icon src="https://cdn.lordicon.com/akuwjdzh.json" trigger="hover" class="ml-2" style="width:22px;height:22px;color:color: rgb(148 163 184);">
                                        </lord-icon>
                                    </span>
                                </a>
                            </div>
